import { NamedNode, st, term, Node } from "rdflib"
...
import { loadMe, getPodRoot } from "../profile/profileLogic"
...
export async function createChatThing(
chatContainer: NamedNode,
me: NamedNode
): Promise<NamedNode> {
...
export function mintNew(newPaneOptions: NewPaneOptions): Promise<CreatedPaneOptions> {
    const kb = store;
